  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="../controller/tasklistController.php" enctype="multipart/form-data" onsubmit="return validateCheckboxes();">
...
<script>
  function validateCheckboxes() {
    const checkboxes = document.querySelectorAll('input[name="users_id[]"]');
