...
(8, 2, 14, '47j467j467', '                      j467j467j467j', 1, '2025-04-13'),
(14, 2, 14, 'asdasd', '                      asdasdasdasd', 1, '2025-04-13');
...
(21, 4, 130, 'Testing345'),
(22, 4, 130, 'Testing hahaha'),
(23, 4, 132, 'Tetsinga dviser commnet\r\n'),
(24, 4, 132, 'asdfasfawsfasf'),
(25, 4, 132, 'qwdqwfqwfqwfqw'),
(26, 4, 130, 'Testing Student coment 12 29'),
(27, 4, 130, 'Testing 123'),
(28, 4, 130, 'Testing123'),
(29, 4, 132, 'Adviser Testing123\r\n');
...
--
ALTER TABLE `task_comment`
  MODIFY `task_comment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `task_like`
--
ALTER TABLE `task_like`
  MODIFY `task_like_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `task_member`
--
ALTER TABLE `task_member`
  MODIFY `task_member_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
